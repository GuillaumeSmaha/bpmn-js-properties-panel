...
/**
 * Create camunda:tag element from given binding.
 *
 * @param {PropertyBinding} binding
 * @param {String} value
 * @param {BpmnFactory} bpmnFactory
 ...
 * @return {ModdleElement}
 */
function createCamundaTag(binding, value, bpmnFactory) {
  return bpmnFactory.create(binding.name, {
    value: value || ''
  });
}

module.exports.createCamundaTag = createCamundaTag;
