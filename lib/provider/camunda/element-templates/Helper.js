...
function getDefaultTemplate(element, elementTemplates) {
  ...
  elementTemplates.forEach(function(t) {
    ...
    if (isAny(element, t.appliesTo) && t.isDefault) {
      defaultTemplate = t;
    }
  });
...
function findCamundaTag(element, binding) {

  return findExtension(element, binding.name);
}

module.exports.findCamundaTag = findCamundaTag;
